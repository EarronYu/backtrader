...
from strategies.BollingerKeltnerChannel import BBKCPO
...
def runstrat(args=None):
    # setup entrance
    cerebro = bt.Cerebro()
    cerebro.addstrategy(BBKCPO)
    # cerebro.addstrategy(SimpleBollinger)
    # prepare data
    t0str, t9str = '2019-01-01', '2021-12-01'
    symbol = 'ETHUSDT'
    fgCov = False
    ...
    print(returns)
    returns.to_csv(f'..//data//returns_test.csv')
